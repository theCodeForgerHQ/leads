...
from .sources import CompanyPageJobsSource, WaasJobsSource, YcOssSource
...
class Pipeline:
    def __init__(self, cfg: Config, yc: YcOssSource, jobs_src: CompanyPageJobsSource) -> None:
        self.cfg = cfg
        self.yc = yc
    ...
    def run(self) -> tuple[list[MatchedCompany], RunSummary]:
        ...
        jobs = self.jobs_src.software_jobs(companies)     # Stage 2
